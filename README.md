...
Untitled
```
* `MinimumSnap_OSQP` contains the version using OSQP, download the project run the following command, OSQP will solve the problem quickly.In this project, we use the first demo in 
